public class As3_ParallelSort {
    public static String airport[] = MyFiles.loadStringArr("Unit-1/IntelliJ_DataSet/BusiestAirports/airport.txt");
    public static String country[] = MyFiles.loadStringArr("Unit-1/IntelliJ_DataSet/BusiestAirports/country.txt");
    public static int totalpassengers[] = MyFiles.loadIntArr("Unit-1/IntelliJ_DataSet/BusiestAirports/totalpassengers.txt");
    public static int year[] = MyFiles.loadIntArr("Unit-1/IntelliJ_DataSet/BusiestAirports/year.txt");
